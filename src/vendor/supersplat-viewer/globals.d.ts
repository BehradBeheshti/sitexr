...
interface Window {
    ...
    sse: {
        options: Omit<import('./options').CreateViewerOptions, 'container' | 'settings'>,
...
declare module 'playcanvas/scripts/esm/xr/xr-controllers.mjs' {
    const XrControllers: typeof import('playcanvas').Script;
    export { XrControllers };
}

declare module 'playcanvas/scripts/esm/xr/xr-navigation.mjs' {
    const XrNavigation: typeof import('playcanvas').Script;
    export { XrNavigation };
}
