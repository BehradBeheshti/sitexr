...
import type { Collision } from './collision'; // SITEXR
import type { CameraManager } from './camera-manager'; // SITEXR
...
type ViewerHandle = {
     ...
     */
    destroy(): void;
    /** SITEXR: internals the XR locomotion layer builds on. */
    readonly internals: {
        camera: Entity;
...
export type { CameraMode, InputMode, Config, State, Global, ViewerState, CaptureOptions, ViewerHandle }; // SITEXR: type-only
